...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
      Explore our handpicked selection of exquisite villas that redefine luxury living. Each property offers stunning design, premium amenities, and unparalleled comfort, ensuring a perfect getaway for you and your loved ones.
      </p>
